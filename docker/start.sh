...
: "${MATERIALSCOPE_LIBRARY_CLOUD_URL:=${THERMOANALYZER_LIBRARY_CLOUD_URL:-http://127.0.0.1:8000}}"
export MATERIALSCOPE_LIBRARY_CLOUD_URL
export THERMOANALYZER_LIBRARY_CLOUD_URL="${THERMOANALYZER_LIBRARY_CLOUD_URL:-$MATERIALSCOPE_LIBRARY_CLOUD_URL}"
