    ...
    with st.expander(t("sidebar.about")):
        if st.session_state.get("ui_language", "tr") == "tr":
            st.markdown(
                ...
                "**Ana akış**\n"
                "- NETZSCH, TA veya generic CSV/XLSX koşularını içe aktar\n"
                "- Çoklu koşuları tek overlay alanında karşılaştır\n"
                "- DSC ve TGA olaylarını proje durumu ile birlikte analiz et\n"
                "- Markalı DOCX/PDF/CSV/XLSX çıktıları üret\n\n"
            ...
            st.markdown(
                ...
                "**Core workflow**\n"
                "- Import runs from NETZSCH, TA, or generic CSV/XLSX exports\n"
                "- Compare multiple runs in one overlay workspace\n"
                "- Analyze DSC and TGA events with reusable project state\n"
                "- Deliver branded DOCX/PDF/CSV/XLSX outputs\n\n"
                "**Lab Preview modules**\n"
