...
def test_layout_contains_section_ids_in_order():
    ...
    expected_ids = [
        ...
        "raman-result-figure",
        "raman-figure-save-snapshot-btn",
        "raman-figure-use-report-btn",
        "raman-figure-artifact-status",
        "raman-result-figure-artifacts",
        "raman-figure-artifacts-summary",
        "raman-figure-artifact-refresh",
