...
_SIGNAL_PIPELINE_SECTIONS = {
    ...
    "FTIR": ("smoothing", "baseline", "normalization", "axis_conversion", "signal_conversion"),
    "RAMAN": ("smoothing", "baseline", "normalization", "axis_conversion", "signal_conversion"),
...
_ANALYSIS_STEP_SECTIONS = {
    ...
    "DTA": ("peak_detection",),
    "FTIR": ("peak_detection", "similarity_matching", "region_integration"),
    "RAMAN": ("peak_detection", "similarity_matching", "region_integration"),
