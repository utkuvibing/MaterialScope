...
TRANSLATIONS = {
    ...
    "dash.analysis.spectral.plot.card_title": {"tr": "Grafik Ayarları", "en": "Plot Settings"},
    "dash.analysis.spectral.plot.card_hint": {
        "tr": "Spektrum görünümünü ve dışa aktarma ölçeğini ayarlayın.",
        "en": "Tune spectrum display and export scale.",
    },
    "dash.analysis.spectral.plot.legend": {"tr": "Lejant", "en": "Legend"},
    "dash.analysis.spectral.plot.compact": {"tr": "Kompakt görünüm", "en": "Compact layout"},
    "dash.analysis.spectral.plot.show_grid": {"tr": "Izgarayı göster", "en": "Show grid"},
    "dash.analysis.spectral.plot.show_spikes": {"tr": "Crosshair çizgilerini göster", "en": "Show crosshair spikes"},
    "dash.analysis.spectral.plot.reverse_x_axis": {"tr": "X eksenini ters çevir", "en": "Reverse x-axis"},
    "dash.analysis.spectral.plot.export_scale": {"tr": "Export ölçeği", "en": "Export scale"},
    "dash.analysis.spectral.plot.line_width": {"tr": "Çizgi kalınlığı", "en": "Line width"},
    "dash.analysis.spectral.plot.marker_size": {"tr": "İşaretçi boyutu", "en": "Marker size"},
    "dash.analysis.spectral.plot.show_raw": {"tr": "Ham izi göster", "en": "Show raw trace"},
    "dash.analysis.spectral.plot.show_smoothed": {"tr": "Yumuşatılmış izi göster", "en": "Show smoothed trace"},
    "dash.analysis.spectral.plot.show_corrected": {"tr": "Düzeltilmiş izi göster", "en": "Show corrected trace"},
    "dash.analysis.spectral.plot.show_normalized": {"tr": "Normalize izi göster", "en": "Show normalized trace"},
    "dash.analysis.spectral.plot.show_peaks": {"tr": "Pik işaretçilerini göster", "en": "Show peak markers"},
    "dash.analysis.spectral.plot.x_lock": {"tr": "X aralığını sabitle", "en": "Lock X range"},
    "dash.analysis.spectral.plot.y_lock": {"tr": "Y aralığını sabitle", "en": "Lock Y range"},
