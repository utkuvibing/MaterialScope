...
TRANSLATIONS = {
    ...
    "dash.analysis.xrd.figure.btn_snapshot": {"tr": "Anlık görüntüyü kaydet", "en": "Save snapshot"},
    "dash.analysis.xrd.figure.btn_report": {"tr": "Rapor grafiği olarak kullan", "en": "Use as report figure"},
    ...
    "dash.analysis.xrd.figure.artifact_skip": {"tr": "Şekil kaydı atlandı: {reason}", "en": "Figure registration skipped: {reason}"},
    "dash.analysis.xrd.figure.artifact_error": {"tr": "Şekil kaydı başarısız: {reason}", "en": "Figure registration failed: {reason}"},
    ...
    "dash.analysis.xrd.figure.overlay_label": {"tr": "Grafik için faz adayı", "en": "Phase candidate overlay"},
    ...
    "dash.analysis.ftir.similarity.hint": {"tr": "Kütüphane araması için en iyi aday sayısı ve minimum skor.", "en": "Top candidate count and minimum score for library search."},
