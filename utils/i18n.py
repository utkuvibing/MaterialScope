...
TRANSLATIONS = {
    ...
    "dash.analysis.raman.similarity.hint": {"tr": "K?t?phane aramas? i?in en iyi aday say?s?, metrik ve minimum skor.", "en": "Metric, top candidate count, and minimum score for library search."},
    "dash.analysis.raman.similarity.metric": {"tr": "Benzerlik metri?i", "en": "Similarity metric"},
    "dash.analysis.raman.similarity.metric.cosine": {"tr": "Kosin?s", "en": "Cosine"},
    ...
    "dash.analysis.ftir.similarity.hint": {"tr": "K?t?phane aramas? i?in en iyi aday say?s?, metrik ve minimum skor.", "en": "Metric, top candidate count, and minimum score for library search."},
    "dash.analysis.ftir.similarity.metric": {"tr": "Benzerlik metri?i", "en": "Similarity metric"},
    "dash.analysis.ftir.similarity.metric.cosine": {"tr": "Kosin?s", "en": "Cosine"},
